...
var PrismSlider = (function(window, undefined) {
  ...
  PrismSlider.prototype.renderMask_ = function() {
    var w = this.settings.container.sizes.w / 3;
    var h = this.settings.container.sizes.h / 1.575;

    var centerX = this.canvas.width / 2 - w / 2;
    // var centerY = this.canvas.height / 2 - h*1.5;

    var centerY = this.canvas.height / 2 - h * 0.75;
