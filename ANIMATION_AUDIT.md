...
| -------------------- | -------------------------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mountIntro()`       | `data-anim="intro-up\|down\|fade"`           | `slide-up-intro`, `fade-up-intro`, `fade-down-intro`, `hero_img-intro`         | ✅ Live. One-shot GSAP timeline at boot, no scroll trigger.                                                                                                                                                               |
