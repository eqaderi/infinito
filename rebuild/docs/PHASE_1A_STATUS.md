...
> Last updated: **2026-07-08** — Above-the-fold hero un-gated for LCP (#43): CSS-driven intros, latin-only font subsets, `x-cloak` overlays, Playfair preload, inlined CSS. Simulate perf 0.89→0.93; LCP budget calibration deferred to #79.
