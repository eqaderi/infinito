...
HeaderScroller.prototype =
{
    ...
    _resize: function()
    {
        var h = this._canvas.clientHeight === 0? window.innerHeight : this._canvas.clientHeight;
        var width = Math.round(h * this._aspectRatio);
        this._canvas.height = this._canvas.clientHeight;
        this._canvas.style.width = width + "px";
        this._canvas.width = width;

        // this tries to get the pencil in clear view
        // var diff = Math.min(window.innerWidth - width, 0.0);
        // this._canvas.style.left = diff+"px";
        // this._canvas.style.left = 0+"px";
